...
Player.prototype = _.extend({
    ...
    cmd: function(command, arguments) {
        ...
        if(this.options.debug) {
            ...
            console.log("here", [command].concat(arguments[0]))
        }
        //  if(command == "loadFile"){
        //     this.instance.stdin.write(command + " " + arguments + '\n');
        // } else {
            this.instance.stdin.write([command].concat(arguments[0]) + '\n');
        // }
